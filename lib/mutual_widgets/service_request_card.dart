...
class ServiceRequestCard extends StatelessWidget {
  ...
  ServiceRequestCard(this.serviceRequest);
              ...
              Flexible(
                child: AspectRatio(
                  ...
                  child: CachedNetworkImage(
                    imageUrl: serviceRequest.customerImages.isEmpty
                        ? 'https://i.stack.imgur.com/y9DpT.jpg'
                        : serviceRequest.customerImages.first,
                    placeholder: (context, url) =>
                        assetImage("images/placeholderImage.png", context),
                    errorWidget: (context, url, error) => Icon(Icons.error),
                    fit: BoxFit.cover,
                  ),
                  // child: Image.network(serviceRequest.customerImages.first),
                ),
              ),
              Flexible(
                flex: 2,
